...
begin
  ...
  read(ch)
    ...
    try:
        ...
        # 2. Семантический анализ + диагностика + модификация AST
        analyzer = SemanticAnalyzer()
        analyzer.visit(program)
        print("\nСемантический анализ пройден. AST аннотировано типами.")

        # 3. Генерация исполняемого кода
        codegen = PythonCodeGenerator()
        python_code = codegen.generate(program)
        ...
        print(f"Семантическая ошибка: {e.message}")
